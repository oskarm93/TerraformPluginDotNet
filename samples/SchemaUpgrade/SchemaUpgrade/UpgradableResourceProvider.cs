...
{
    public Task<PlanResult<UpgradableResourceV2>> PlanAsync(UpgradableResourceV2 prior, UpgradableResourceV2 proposed)
    {
        return Task.FromResult(new PlanResult<UpgradableResourceV2> { Result = proposed });
    }
